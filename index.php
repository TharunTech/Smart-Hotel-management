<!DOCTYPE html>
<html lang="en">
<!--color pallet link=https://colorhunt.co/palette/f5f0bbc4dfaa90c8ac73a9ad-->
<head>
    ...
    <title>Welcome | Smart Foods</title>
</head>

<body class="d-flex flex-column h-100 cl-1">

    <?php include('nav_header.php')?>

    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to Smart Foods</h1>
            <p class="lead fw-normal">online Food ordering system </p>
        </div>
    </div>
